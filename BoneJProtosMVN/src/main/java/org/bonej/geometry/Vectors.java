...
public class Vectors {
    ...
    /**
     * Calculate the angle between two vectors u,v joined at their tails at the point
     * (tailX, tailY, tailZ)
     *
     * @param ux
     ...
     * @return
     * 		angle formed by u-tail-v
     */
    public static double joinedVectorAngle(double ux, double uy, double uz, double vx,
                                           double vy, double vz, double tailX, double tailY, double tailZ) {
     ...
     * @param v     Another three dimensional vector
     * @param tail  The point where the tails of the vectors u & v meet
     * @return      Angle formed by u-tail-v
     *
     * This method does not change the state of the vectors u, v and tail.
     */
