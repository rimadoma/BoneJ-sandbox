...
/**
 * Static helper methods for the package Ops to get around ImageJ1 / ImageJ2 incompatibility issues.
 *
 * Needed because IJ2 Ops / Plugins can't return ImageJ1 classes from their methods.
 *
...
public class StaticTestImageHelper
{
     ...
     * @return      A 2D image containing a white (255) circle on black (0) background
     *
     */
