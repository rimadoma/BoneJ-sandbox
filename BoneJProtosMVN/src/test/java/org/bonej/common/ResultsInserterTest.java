...
public class ResultsInserterTest {
	...
	@Test
	public void testSetImageMeasurementInFirstFreeRowAddsARowForNewImage() throws Exception {
		final int COLUMN = 0;
	...
	@Test
	public void testSetImageMeasurementInFirstFreeRowAddsARowForRepeatMeasurement() throws Exception {
		beforeCount = resultsTable.getCounter();
		resultsInserter.setMeasurementInFirstFreeRow(LABEL, MEASUREMENT_HEADING, MEASUREMENT_VALUE);
		resultsInserter.setMeasurementInFirstFreeRow(LABEL, MEASUREMENT_HEADING, MEASUREMENT_VALUE);
		afterCount = resultsTable.getCounter();
	...
	@Test
	public void testSetImageMeasurementInFirstFreeRowAddsAColumnForNewMeasurement() throws Exception {
		beforeCount = resultsTable.getCounter();
		resultsInserter.setMeasurementInFirstFreeRow(LABEL, MEASUREMENT_HEADING, MEASUREMENT_VALUE);
	...
	@Test
	public void testSetImageMeasurementInFirstFreeRowAddsColumnToTheFirstRowWithTheSameLabel() throws Exception {
	...
	@Test
	public void testSetImageMeasurementInFirstFreeRowAddsColumnValueToTheFirstRowWithNoData() throws Exception {
		resultsInserter.setMeasurementInFirstFreeRow(LABEL, MEASUREMENT_HEADING, MEASUREMENT_VALUE);
		resultsInserter.setMeasurementInFirstFreeRow(LABEL, MEASUREMENT_HEADING, MEASUREMENT_VALUE);
		resultsInserter.setMeasurementInFirstFreeRow(LABEL, MEASUREMENT_HEADING, MEASUREMENT_VALUE);
